...
- 11 самостійних навчальних етапів.
...
- Випадкове перемішування варіантів відповідей у діалогах.
...
| 5 | Зворотна сторона знака | Не шукати вихід навмання, залишитися на місці та набрати номер екстреної служби. |
...
| 8 | Повітряна загроза у дворі | Зупинитися, оцінити оточення та перейти до доступнішого безпечного місця. |
| 9 | Скляна зупинка та БПЛА | Відійти від скла й дістатися мобільного укриття, не рухаючись назустріч загрозі. |
...
│       ├── stage01.js
│       ├── ...
│       └── stage11.js          # окрема логіка кожного навчального етапу
...
Адреса проєкту та publishable key налаштовуються на початку `js/registration.js`.
...
Результати проходження етапів зараз показуються лише в інтерфейсі й не записуються до Supabase.
...
- Метрики проходження не мають серверної історії або адміністративної панелі.
