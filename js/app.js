import { TrainingWorld } from "./game3d.js?v=20260923-citywalk-2";
import {
...
const resultContent = {
  ...
  "stage-04": {
    ...
    message:
      "Ви розпізнали непрямі ознаки мінної небезпеки, зупинилися, попередили інших, повернулися своїм шляхом і повідомили екстрену службу.",
    guidance:
      "Неофіційні позначки та сукупність підозрілих ознак потрібно сприймати як можливу небезпеку: зупиніться, попередьте інших, поверніться своїм шляхом і повідомте 101, 102 або 112.",
    metrics(metrics) {
      return [
  ...
  "stage-05": {
    ...
    message:
      "Ви розпізнали зворотну сторону можливого знака мінної небезпеки, залишилися на місці, набрали номер і правильно передали інформацію екстреній службі.",
    guidance:
      "Якщо видно зворотну сторону знака й існує ризик перебування на замінованій території, потрібно зупинитися, не рухати ногами, не шукати вихід навмання та повідомити 101, 102 або 112.",
    metrics(metrics) {
      return [
  ...
  "stage-08": {
    title: "На повітряну загрозу відреаговано правильно",
    message:
      "Ви негайно рушили до під’їзду або, коли часу на переміщення вже не залишилося, вчасно зайняли положення лежачи.",
    guidance:
      "Після сигналу тривоги негайно рухайтеся до доступного укриття. Якщо чути стрімке наближення загрози й укриття вже недосяжне, припиніть біг, ляжте на землю та закрийте голову руками.",
    metrics(metrics) {
      return [
        ["Початок руху до під’їзду", formatSeconds(metrics.reactionSeconds)],
        ["Час до під’їзду", formatSeconds(metrics.shelterSeconds)],
        ["Під’їзду досягнуто", metrics.reachedEntrance ? "так" : "ні"],
        ["Положення лежачи після наближення КАБу", metrics.groundPositionChosen ? "виконано" : "не знадобилося"],
        ["Час переходу в положення лежачи", formatSeconds(metrics.proneSeconds)]
      ];
    }
  },
  "stage-09": {
