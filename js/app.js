import { TrainingWorld } from "./game3d.js?v=20260918-8";
import {
...
const resultContent = {
  ...
  "stage-05": {
    ...
    message:
      "Ви розпізнали зворотну сторону можливого знака мінної небезпеки, залишилися на місці та набрали номер екстреної служби.",
    guidance:
